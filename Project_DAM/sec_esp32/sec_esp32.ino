...
// #define WIFI_SSID "Redmi Note 8 (2021)"                            // "MEO-CFA840"    // "Vodafone-E346D8"
// #define WIFI_PASSWORD "12345678"                       // "cc3c2f82a9"      // "fA9dxnpg3f2mdA8z"

// Insert your network credentials
#define WIFI_SSID "labs"
#define WIFI_PASSWORD "robot1cA!ESTG"
...
const int ledPin_good_qual = 33;

const int ledPin_door_servomotor = 25;
...
void loop() {
  ...
  //  int * control_data_second = read_all_states();
    ...
    int control_data_second[] = {1,1,1,1,1,1};
