# -*- coding: utf-8 -*-
"""
Created on Mon Dec 26 14:30:20 2022
...
def first_task_by_menu_all(dir_path, width_dim, height_dim, fps_value):
    ...
    from control_exec import gui_metadata_files, aux_guis_first_menu, control_stream
    ...
    k_left = extract_params_infrared_metadata(meta_left)
    k_right = extract_params_infrared_metadata(meta_right)
    ...
    try:
     ...
     #         Z_res = cv2.cvtColor(Z_res, cv2.COLOR_BGR2GRAY)   
            ...
            cv2.imwrite("Z_res_aux.png", Z_res)      ## run again
    ...
    #        name_csv_file = new_path + name_csv_file
            ...
            if resp_str == 'Yes' and counter == n_max_images:
                break
