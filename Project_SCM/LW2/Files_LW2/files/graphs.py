# -*- coding: utf-8 -*-
"""
Created on Thu Sep  1 23:14:12 2022
...
dirBuilt += "buffer_management.csv"
...
plt.figure()
plt.grid()
plt.title('CBR - Buffer management along time') 
